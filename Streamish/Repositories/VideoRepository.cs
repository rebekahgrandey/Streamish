    ...
    public class VideoRepository : BaseRepository, IVideoRepository
    {
        ...
        public Video GetById(int id)
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                          SELECT v.Id AS VideoId, v.Title, v.Description, v.Url, v.DateCreated,
                          up.Id AS UserProfileId, up.Name, up.Email, up.ImageUrl, up.DateCreated
                          FROM Video v
            ...
            using (var conn = Connection)
            {
                ...
                using (var cmd = conn.CreateCommand())
                {
                    cmd.CommandText = @"
                          ...
                          c.Id AS CommentId, c.Message, c.VideoId, c.UserProfileId,
                          up.Id AS UserProfileId, up.Name
                          FROM Video v
                          LEFT JOIN Comment c on c.VideoId = v.Id
